...
def main():
    ...
    # For printing the characters of the example string.
    ...
    print(f"The minimum character is: '{min_char}' (ASCII value: {ord(min_char)})")
    ...
    print(f"The maximum character is: '{max_char}' (ASCII value: {ord(max_char)})")

    # TODO: Find and print the index of the first occurrence of 'o' in the string
    print("\nIndex of 'o':")
    o_index = example_string.index('o')
    print(f"The first 'o' is at index: {o_index}")
    ...
    print(f"The character 'o' appears {o_count} times.")
